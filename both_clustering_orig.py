...
metadata_file = "C:\\Users\\johnp\\EE402Project\\Homework_5\\speakers_english.csv"  # Replace with the actual path to your metadata file
...
audio_dir = "C:\\Users\\johnp\\EE402Project\\Homework_5\\English_Full"  # The directory where the audio files are located
audio_files = [f"english{i}.mp3" for i in range(1, 580)]  # Adjust according to your filenames
